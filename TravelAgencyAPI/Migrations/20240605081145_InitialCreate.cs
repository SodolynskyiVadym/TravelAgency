        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PriceForHundredKm = table.Column<double>(type: "float", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Tours_Places_PlaceEndId",
                        column: x => x.PlaceEndId,
                        principalTable: "Places",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Tours_Places_PlaceStartId",
                        column: x => x.PlaceStartId,
                        principalTable: "Places",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Tours_Transports_TransportToEndId",
                        column: x => x.TransportToEndId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tours_PlaceEndId",
                table: "Tours",
                column: "PlaceEndId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Tours_PlaceStartId",
                table: "Tours",
                column: "PlaceStartId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Tours_TransportToEndId",
                table: "Tours",
                column: "TransportToEndId",
                unique: true);
        }

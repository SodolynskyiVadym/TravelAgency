...
namespace TravelAgencyAPI.Migrations
{
    ...
    [Migration("20240615183540_AddReservePasswordUserModel")]
    partial class AddReservePasswordUserModel
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TravelAgencyAPI.Models.User", b =>
                {
                    ...
                    b.Property<byte[]>("ReservePasswordHash")
                        .HasColumnType("varbinary(max)");

                    b.Property<byte[]>("ReservePasswordSalt")
                        .HasColumnType("varbinary(max)");
            ...
            modelBuilder.Entity("TravelAgencyAPI.Models.Destination", b =>
                {
                    ...
                    b.HasOne("TravelAgencyAPI.Models.Tour", null)
            ...
            modelBuilder.Entity("TravelAgencyAPI.Models.PlaceImageUrl", b =>
                {
                    b.HasOne("TravelAgencyAPI.Models.Place", null)
                        .WithMany("ImagesUrls")
                        .HasForeignKey("PlaceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("TravelAgencyAPI.Models.Tour", b =>
                {
                    ...
                    b.HasOne("TravelAgencyAPI.Models.Place", "PlaceStart")
                        .WithMany()
                        .HasForeignKey("PlaceStartId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("TravelAgencyAPI.Models.Transport", "TransportToEnd")
                        .WithMany()
                        .HasForeignKey("TransportToEndId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
